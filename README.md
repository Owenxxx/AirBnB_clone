...
OOP
 Weight: 5
 Project to be done in teams of 2 people (your team: Oussama Jrhaider)
 Project will start Mar 18, 2024 3:00 AM, must end by Mar 25, 2024 3:00 AM
 Checker was released at Mar 23, 2024 9:00 AM
...
guillaume@ubuntu:~/AirBnB$ 
guillaume@ubuntu:~/AirBnB$ ./test_save_reload_user.py-- Reloaded objects --
